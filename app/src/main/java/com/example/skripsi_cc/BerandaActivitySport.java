...
public class BerandaActivitySport extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        makan_pagi.setOnClickListener(view -> {
            startActivity(new Intent(BerandaActivitySport.this, DetailMakanPagi.class));
        });
        makan_siang.setOnClickListener(view -> {
            startActivity(new Intent(BerandaActivitySport.this, DetailMakanSiang.class));
        });
        makan_malam.setOnClickListener(view -> {
            startActivity(new Intent(BerandaActivitySport.this, DetailMakanMalam.class));
        });
        makan_cemilan.setOnClickListener(view -> {
            startActivity(new Intent(BerandaActivitySport.this, DetailMakanCemilan.class));
        });
        report.setOnClickListener(view -> {
            startActivity(new Intent(BerandaActivitySport.this, ReportActivity.class));
        });
        profil.setOnClickListener(view -> {
            startActivity(new Intent(BerandaActivitySport.this, ProfilActivity.class));
        });
    }
